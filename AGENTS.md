...
**Workflow**:
1. Use prompt pack from `/prompts/owasp/` with Codex/Copilot
...
- **Part 7**: The Red Queen's Court (deterministic enforcement at the tool-call boundary)
...
2. **Implementation Phase** ([`docs/sdlc/phase2-implementation.md`](docs/sdlc/phase2-implementation.md))
   - Agent selection (Codex/Copilot/ChatGPT)
...
- **Codex** (me!): Complex refactoring, comprehensive testing, technical debt analysis
...
See detailed walkthrough in [README.md](README.md#-example-remediate-injection-a03-with-Codex) or [`docs/workshop/part3-live-remediation.md`](docs/workshop/part3-live-remediation.md).
...
5. Lint: `npm run lint`
6. Commit with AI label: `🤖 AI-assisted with Codex using OWASP A03 prompt pack`
...
4. **Commit Labeling**: Always use `🤖 AI-assisted` in commits
   ...
   🤖 AI-assisted with Codex using OWASP A03 prompt pack"
   ```
