...
- **Phase C** — orchestration workflows in place; reviewer-dispatch path retired per B24 (HOW is human-gated via Looking Glass Run Audit; auto-merge of un-reviewed PRDs is intentionally not enabled).
