...
command: npx @maintainabilityai/research-runner@~0.1.64 skill-self-review-security
---
...
echo '{"okrId":"OKR-2026Q2-IMDB-001-celeb-api","runId":"HOW-2026-05-21-ux9tzd","round":1}' \
  | npx @maintainabilityai/research-runner@~0.1.64 skill-self-review-security
```
