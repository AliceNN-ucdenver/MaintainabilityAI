...
import { parseThreatModelYaml, summarizeThreatModel } from '../core/threat-model-reader';
...
// ============================================================================
// YAML Reader — parse + summary helpers live in core/threat-model-reader.ts
// (vscode-free, so MeshReader can use them too).
// ============================================================================
...
export class ThreatModelService {
  ...
  static readSavedThreatModel(barPath: string): ThreatModelResult | null {
    ...
    try {
      ...
      const { byCategory, byRisk, unmitigatedCount } = summarizeThreatModel(threats);
